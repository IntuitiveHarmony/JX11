...
// Create a namespace for 26 synth parameters
...
public:
    ...
    // Instansiate the apvts, This is what owns the sthnt parameters
    // Usually left public so the UI can access it
    juce::AudioProcessorValueTreeState apvts { *this, nullptr, "Parameters", createParameterLayout() };
    
private:
    // Call the createParameterLayout method.
    // This will instansiate the AudioParameterFloat and AudioParameterChoice objects
    juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout();
    
    // ~68 adding three methods for handling the MIDI buffers~
    ...
    // Pointers to the synth parameters that are owned by the AudioProcessorValueTreeState
